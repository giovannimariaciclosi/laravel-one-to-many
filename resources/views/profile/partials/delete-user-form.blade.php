<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Una volta cancellato l'account, tutti i suoi dati saranno eliminati in modo permanente. Prima di eliminare l'account, scarica tutti i dati e le informazioni che desideri conservare.") }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __("Una volta cancellato l'account, tutti i suoi dati saranno eliminati in modo permanente. Per favore inserisci la tua password per confermare che vuoi cancellare il tuo account definitivamente.") }}
                    </p>
                </div>
